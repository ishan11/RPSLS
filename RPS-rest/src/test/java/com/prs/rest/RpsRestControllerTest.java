...
public class RpsRestControllerTest {
    ...
    public void setup(){
        ...
        stubbedPlayerStatsUseCaseResponse.add( new PlayerStat( player1, 10, 0, 0, 5, 3, 2, 4,6));
        stubbedPlayerStatsUseCaseResponse.add( new PlayerStat( player2, 6, 2, 2, 2, 4, 4, 3,4));
        stubbedPlayerStatsUseCaseResponse.add( new PlayerStat( player3, 2, 4, 4, 3, 3, 4,5,6));
