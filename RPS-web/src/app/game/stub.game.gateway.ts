...
export class StubGameGateway implements GameGateway {
  ...
  constructor(){
    this.playerStats.push(new PlayerStat(new Player("Player 1",1 ), 10, 0, 0, 10, 100, 10, 0, 0, 100, 0, 0,12,24));
    this.playerStats.push(new PlayerStat(new Player("Player 2",2 ), 6, 2, 2, 10, 70, 5, 2, 3, 50, 20, 30,15,25));
    this.playerStats.push(new PlayerStat(new Player("Player 3",3 ), 2, 4, 4, 10, 40, 2, 1, 7, 20, 10, 70,30,13));
  }
